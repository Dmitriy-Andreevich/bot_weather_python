    ...
    for day in req:
        for el in day:
            ...
            if req.__len__() > 1 and datetime.fromtimestamp(el['dt']).hour != 12:
                ...
                draw_bottom_temp(bottom_element_start_x_coord_local, el, paint_layer)

                draw_bottom_img_ico(background, bottom_element_start_x_coord_local, el)

                draw_bottom_time(bottom_element_start_x_coord_local, el, paint_layer)

                draw_bottom_date(bottom_element_start_x_coord_local, el, paint_layer)

                bottom_element_start_x_coord_local += BOTTOM_ELEMENT_OFFSET_X_CORD


def draw_bottom_img_ico(background, bottom_element_start_x_coord_local, el):
...
def draw_bottom_temp(bottom_element_start_x_coord_local, el, paint_layer):
...
def draw_bottom_date(bottom_element_start_x_coord_local, el, paint_layer):
...
def draw_bottom_time(bottom_element_start_x_coord_local, el, paint_layer):
    paint_layer.text((bottom_element_start_x_coord_local + BOTTOM_ELEMENT_DATETIME_OFFSET_X_CORD,
